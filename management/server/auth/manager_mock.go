...
// GetAccountInfoFromPAT implements Manager.
func (m *MockManager) GetAccountInfoFromPAT(ctx context.Context, token string) (user *types.User, pat *types.PersonalAccessToken, domain string, category string, err error) {
